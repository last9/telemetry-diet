...
function parseArgs(argv) {
  ...
  for (let index = 0; index < argv.length; index++) {
    ...
    else if (argv[index] === '--version' || argv[index] === '-v') result.version = true;
...
try {
  ...
  console.error(`Telemetry Diet: ${message}`);
  process.exitCode = 1;
}
